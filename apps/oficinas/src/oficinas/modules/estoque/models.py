...
class Produto(Base):
    ...
    peso_liquido:      Mapped[Decimal] = mapped_column(Numeric(10, 3), default=Decimal("0"))
    peso_bruto:        Mapped[Decimal] = mapped_column(Numeric(10, 3), default=Decimal("0"))
    origem_mercadoria: Mapped[str] = mapped_column(String(1), nullable=False, default="0")
