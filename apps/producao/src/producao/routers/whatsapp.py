...
from producao.config import settings as _default_settings
from auth.dependencies import get_debounce_buffer, get_rate_limiter, get_twilio_client
from producao.ingestion.normalizer import normalize
from core.models.whatsapp import WhatsappSessaoUpdate
...
def list_registros(store: Store = Depends(get_store)):
    ...
    from core.models.enums import OrigemCaptura
    result = []
